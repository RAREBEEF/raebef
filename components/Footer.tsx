...
const Footer = () => {
  return (
    <footer className="relative min-w-[360px] max-w-[1300px] h-fit mt-32 mx-auto flex flex-col justify-center items-center gap-y-5 text-zinc-800 border-t-2 border-zinc-300">
