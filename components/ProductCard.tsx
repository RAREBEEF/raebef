  ...
  return (
    <li className="group relative aspect-[4/5] xs:aspect-auto">
      ...
      <Link
        ...
        className={`group-hover:rotate-y-180 relative flex h-full shrink-0 flex-col items-center justify-between gap-2 overflow-hidden rounded-md bg-white py-2 text-center shadow-lg shadow-zinc-300 transition-all duration-500 group-hover:shadow-zinc-400 xs:flex-row xs:px-2`}
      >
